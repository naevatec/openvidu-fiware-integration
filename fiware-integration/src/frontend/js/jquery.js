	...
	---------------------------------------------------------------------- */
            ...
            Sizzle.matchesSelector = function (elem, expr) {
                ...
                if (support.matchesSelector && documentIsHTML && !nonnativeSelectorCache[expr + " "] &&
                    (!rbuggyMatches || !rbuggyMatches.test(expr)) && (!rbuggyQSA || !rbuggyQSA.test(expr))) {
                    ...
                    "CLASS": function (className) {
                        ...
                        return pattern ||
                            ...
                            classCache(className, function (elem) {
                                return pattern.test(
                                    typeof elem.className === "string" && elem.className || typeof elem.getAttribute !==
                            ...
                            while ((elem = elem[dir])) {
                                if (elem.nodeType === 1 || checkNonElements) {
                                    ...
                                    if (skip && skip === elem.nodeName.toLowerCase()) {
                                        elem = elem[dir] || elem;
                                    } else if ((oldCache = uniqueCache[key]) && oldCache[0] === dirruns &&
                                        oldCache[1] === doneName) {
                ...
                return markFunction(function (seed, results, context, xml) {
                    ...
                    if (seed) {
                        if (postFinder || preFilter) {
                            ...
                            i = matcherOut.length;
                            while (i--) {
                                if ((elem = matcherOut[i]) && (temp = postFinder ? indexOf(seed, elem) : preMap[i]) >
                                    -1) {
 ...
 */
    ...
    function adjustCSS(elem, prop, valueParts, tween) {
        var adjusted, scale, maxIterations = 20, currentValue = tween ? function () {
            ...
            initialInUnit = elem.nodeType && (jQuery.cssNumber[prop] || unit !== "px" && +initial) &&
 ...
 */
                    ...
                    if (cur.nodeType === 1 && !(event.type === "click" && cur.disabled === true)) {
                        ...
                        for (i = 0; i < delegateCount; i++) {
                            ...
                            if (matchedSelectors[sel] === undefined) {
                                matchedSelectors[sel] = handleObj.needsContext ? jQuery(sel, this).index(cur) > -1 :
        ...
        special: {
            ...
            click: {
                ...
                _default: function (event) {
                    ...
                    return rcheckableType.test(target.type) && target.click && nodeName(target, "input") &&
                        dataPriv.get(target, "click") || nodeName(target, "a");
                }
            },
    ...
    function getWidthOrHeight(elem, dimension, extra) {
        ...
        if ((!support.boxSizingReliable() && isBorderBox || val === "auto" || !parseFloat(val) &&
            jQuery.css(elem, "display", false, styles) === "inline") && elem.getClientRects().length) {
            ...
            set: function (elem, value, extra) {
                ...
                if (isBorderBox && scrollboxSizeBuggy) {
                    subtract -= Math.ceil(elem["offset" + dimension[0].toUpperCase() + dimension.slice(1)] -
                        parseFloat(styles[dimension]) - boxModelAdjustment(elem, dimension, "border", false, styles) -
                        0.5);
                }
        ...
        if (Array.isArray(obj)) {
            ...
            jQuery.each(obj, function (i, v) {
                if (traditional || rbracket.test(prefix)) {
                    ...
                    buildParams(prefix + "[" + (typeof v === "object" && v != null ? i : "") + "]", v, traditional,
                        add);
                }
            });
    ...
    jQuery.extend({
		...
		*/
        ...
        ajax: function (url, options) {
            ...
            } else if (s.data && s.processData && (s.contentType || "").indexOf("application/x-www-form-urlencoded") ===
                0) {
                        ...
                        return function () {
                            if (callback) {
                                callback = errorCallback = xhr.onload =
                                    xhr.onerror = xhr.onabort = xhr.ontimeout = xhr.onreadystatechange = null;
                                ...
                                if (type === "abort") {
                                    ...
                                    complete(xhrSuccessStatus[xhr.status] || xhr.status, xhr.statusText,
                                        ...
                                        (xhr.responseType || "text") !== "text" || typeof xhr.responseText !==
                                        "string" ? {binary: xhr.response} : {text: xhr.responseText},
