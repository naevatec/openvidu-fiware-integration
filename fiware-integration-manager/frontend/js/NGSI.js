...
(function () {
    ...
    var interpolate = function interpolate(pattern, attributes) {
        return pattern.replace(/%\(\w+\)s/g, function (match) {
    ...
    var makeJSONRequest2 = function makeJSONRequest2(url, options) {
        ...
        return this.makeRequest(url, options).then(function (response) {
    ...
    var ngsi_build_entity_id_element_json = function ngsi_build_entity_id_element_json(entity) {
        ...
        isPattern = (typeof entity.isPattern === "string" && entity.isPattern.trim().toLowerCase() === "true") ||
    ...
    var ngsi_build_register_context_request = function ngsi_build_register_context_request(e, attr, duration,
        providingApplication, regId) {
    ...
    var ngsi_build_update_context_request = function ngsi_build_update_context_request(updateAction, update) {
        var body, i, j, contextElement, attributeListElement, attributes, attribute, attributeElement, value;
    ...
    var ngsi_build_discover_context_availability_request = function ngsi_build_discover_context_availability_request(e,
        attr) {
        var doc, i;
    ...
    var ngsi_build_subscribe_update_context_availability_request = function ngsi_build_subscribe_update_context_availability_request(e,
        attr, duration, restriction, subscriptionId, onNotify) {
        var doc, i;
    ...
    var ngsi_build_subscribe_update_context_request = function ngsi_build_subscribe_update_context_request(subscriptionId,
        e, attr, duration, throttling, conditions, onNotify) {
    ...
    var parse_context_response_list_json = function parse_context_response_list_json(elements, update_response,
        options) {
        var contextResponse, entry, flat, i, j, value, data, attribute_info, attribute_entry, status_info, error_data;
    ...
    var process_error_code_json = function process_error_code_json(data) {
        if ("errorCode" in data) {
            throw new NGSI.InvalidRequestError(parseInt(data.errorCode.code, 10), data.errorCode.reasonPhrase,
    ...
    var parse_bad_request = function parse_bad_request(response, correlator) {
        ...
        return Promise.reject(new NGSI.BadRequestError({
    ...
    var parse_not_found_response = function parse_not_found_response(response, correlator) {
        ...
        return Promise.reject(new NGSI.NotFoundError({
            message: error.description,
            correlator: correlator
        }));
    };
    ...
    var parse_too_many_results = function parse_too_many_results(response, correlator) {
        ...
        return Promise.reject(new NGSI.TooManyResultsError({
            message: error.description,
            correlator: correlator
        }));
    };
     ...
     */
    NGSI.ProxyConnection.prototype.associateSubscriptionId =
        function associateSubscriptionId(callback, subscription, version) {
            var priv = privates.get(this);
        ...
        return makeJSONRequest2.call(this, url, {
            ...
            if (response.status !== 200) {
                return Promise.reject(
                    new NGSI.InvalidResponseError("Unexpected error code: " + response.status, correlator));
            }
            ...
            try {
                ...
                return Promise.reject(
                    new NGSI.InvalidResponseError("Server returned invalid JSON content", correlator));
            }
     ...
     *
     */
    NGSI.Connection.prototype.createRegistration =
        function createRegistration(entities, attributes, duration, providingApplication, callbacks) {
     ...
     *
     */
    NGSI.Connection.prototype.updateRegistration =
        function updateRegistration(regId, entities, attributes, duration, providingApplication, callbacks) {
            if (!Array.isArray(entities) || entities.length === 0) {
                throw new TypeError("entities parameter must be a non-empty array");
            }
    ...
    NGSI.Connection.prototype.cancelRegistration = function cancelRegistration(regId, callbacks) {
        ...
        this.updateRegistration(regId, [{id: "canceled registration"}], [], "PT0H", "http://canceled.registration.com",
            callbacks);
    };
     ...
     *
     */
    NGSI.Connection.prototype.discoverAvailability =
        function discoverAvailability(entities, attributeNames, callbacks) {
     ...
     *
     */
    NGSI.Connection.prototype.createAvailabilitySubscription =
        function createAvailabilitySubscription(entities, attributeNames, duration, restriction, options) {
            ...
            if (typeof options.onNotify === "function" && this.ngsi_proxy != null) {
                ...
                this.ngsi_proxy.requestCallback(onNotify).then(function (proxy_callback) {
                    var payload = ngsi_build_subscribe_update_context_availability_request(entities, attributeNames,
                        duration, restriction, null, proxy_callback.url);
                    ...
                    makeJSONRequest.call(this, url, payload, parse_subscribe_update_context_availability_response,
                        options);
                }.bind(this), function () {
                ...
                var payload = ngsi_build_subscribe_update_context_availability_request(entities, attributeNames,
                    duration, restriction, null, options.onNotify);
     ...
     *
     */
    NGSI.Connection.prototype.updateAvailabilitySubscription =
        function updateAvailabilitySubscription(subId, entities, attributeNames, duration, restriction, callbacks) {
            if (subId == null) {
            ...
            var payload = ngsi_build_subscribe_update_context_availability_request(entities, attributeNames, duration,
                restriction, subId);
     ...
     *   successful or not
     */
    NGSI.Connection.prototype.cancelAvailabilitySubscription =
        function cancelAvailabilitySubscription(subId, callbacks) {
            if (subId == null) {
                throw new TypeError("subId parameter cannot be null");
            }
     ...
     *
     */
    NGSI.Connection.prototype.createSubscription =
        function createSubscription(entities, attributeNames, duration, throttling, cond, options) {
            if (!Array.isArray(entities) || entities.length === 0) {
                throw new TypeError("entities parameter must be a non-empty array");
            }
            ...
            if (typeof options.onNotify === "function" && this.ngsi_proxy != null) {
                ...
                this.ngsi_proxy.requestCallback(onNotify).then(function (proxy_callback) {
                    var payload = ngsi_build_subscribe_update_context_request(null, entities, attributeNames, duration,
                        throttling, cond, proxy_callback.url);
                ...
                var payload = ngsi_build_subscribe_update_context_request(null, entities, attributeNames, duration,
                    throttling, cond, options.onNotify);
                makeJSONRequest.call(this, url, payload, parse_subscribe_context_response, options);
            }
        };
     ...
     * );
     */
    NGSI.Connection.prototype.updateSubscription =
        function updateSubscription(subId, duration, throttling, cond, options) {
            if (subId == null) {
                throw new TypeError("subId parameter cannot be null");
            }
    ...
    NGSI.Connection.V2.prototype.createEntity = function createEntity(entity, options) {
        ...
        return makeJSONRequest2.call(connection, url, {
            ...
            } else if ((options.upsert !== true && response.status !== 201) ||
                (options.upsert === true && [201, 204].indexOf(response.status) === -1)) {
                return Promise.reject(
                    new NGSI.InvalidResponseError("Unexpected error code: " + response.status, correlator));
            }
            return Promise.resolve({
    ...
    NGSI.Connection.V2.prototype.getEntity = function getEntity(options) {
        ...
        var connection = privates.get(this);
        var url = new URL(interpolate(NGSI.endpoints.v2.ENTITY_ENTRY, {entityId: encodeURIComponent(options.id)}),
            connection.url);
        var parameters = {};
    ...
    NGSI.Connection.V2.prototype.getEntityAttributes = function getEntityAttributes(options) {
        ...
        var connection = privates.get(this);
        var url = new URL(
            interpolate(NGSI.endpoints.v2.ENTITY_ATTRS_COLLECTION, {entityId: encodeURIComponent(options.id)}),
            connection.url);
        var parameters = {};
        if (options.type != null) {
            parameters.type = options.type;
    ...
    NGSI.Connection.V2.prototype.appendEntityAttributes = function appendEntityAttributes(changes, options) {
        ...
        var connection = privates.get(this);
        var url = new URL(
            interpolate(NGSI.endpoints.v2.ENTITY_ATTRS_COLLECTION, {entityId: encodeURIComponent(changes.id)}),
            connection.url);
        var parameters = {};
        var optionsparams = [];
    ...
    NGSI.Connection.V2.prototype.replaceEntityAttributes = function replaceEntityAttributes(entity, options) {
        ...
        var connection = privates.get(this);
        var url = new URL(
            interpolate(NGSI.endpoints.v2.ENTITY_ATTRS_COLLECTION, {entityId: encodeURIComponent(entity.id)}),
            connection.url);
        var parameters = {};
    ...
    NGSI.Connection.V2.prototype.getEntityAttribute = function getEntityAttribute(options) {
        ...
        var connection = privates.get(this);
        var url = new URL(interpolate(NGSI.endpoints.v2.ENTITY_ATTR_ENTRY, {
    ...
    NGSI.Connection.V2.prototype.getEntityAttributeValue = function getEntityAttributeValue(options) {
        ...
        var connection = privates.get(this);
        var url = new URL(interpolate(NGSI.endpoints.v2.ENTITY_ATTR_VALUE_ENTRY, {
            entityId: encodeURIComponent(options.id),
            attribute: encodeURIComponent(options.attribute)
        }), connection.url);
        var parameters = {};
    ...
    NGSI.Connection.V2.prototype.getType = function getType(options) {
        ...
        var connection = privates.get(this);
        var url = new URL(interpolate(NGSI.endpoints.v2.TYPE_ENTRY, {typeId: encodeURIComponent(options.id)}),
            connection.url);
    ...
    NGSI.Connection.V2.prototype.createSubscription = function createSubscription(subscription, options) {
        ...
        if ("callback" in subscription.notification) {
            ...
            p = connection.ngsi_proxy.requestCallback(onNotify).then(function (response) {
        ...
        return p.then(function () {
            ...
            try {
                ...
                return Promise.reject(
                    new NGSI.InvalidResponseError("Unexpected location header: " + location_header, correlator));
            }
    ...
    NGSI.Connection.V2.prototype.getSubscription = function getSubscription(options) {
        ...
        var connection = privates.get(this);
        var url = new URL(
            interpolate(NGSI.endpoints.v2.SUBSCRIPTION_ENTRY, {subscriptionId: encodeURIComponent(options.id)}),
            connection.url);
    ...
    NGSI.Connection.V2.prototype.updateSubscription = function updateSubscription(changes, options) {
        ...
        var connection = privates.get(this);
        var url = new URL(
            interpolate(NGSI.endpoints.v2.SUBSCRIPTION_ENTRY, {subscriptionId: encodeURIComponent(changes.id)}),
            connection.url);
