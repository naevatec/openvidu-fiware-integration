...
(function (global, factory) {
    ...
    function toString(val) {
        return val == null ? "" :
            Array.isArray(val) || (isPlainObject(val) && val.toString === _toString) ? JSON.stringify(val, null, 2) :
                String(val);
    }
    ...
    var hasSymbol = typeof Symbol !== "undefined" && isNative(Symbol) && typeof Reflect !== "undefined" &&
...

    {
        ...
        formatComponentName = function (vm, includeFile) {
            ...
            var options = typeof vm === "function" && vm.cid != null ? vm.options :
            ...
            if (vm._isVue && vm.$parent) {
                ...
                .map(function (vm, i) {
                    return ("" + (i === 0 ? "---> " : repeat(" ", 5 + i * 2)) +
                        (Array.isArray(vm) ? ((formatComponentName(vm[0])) + "... (" + (vm[1]) + " recursive calls)") :
    ...
    function cloneVNode(vnode) {
        var cloned = new VNode(vnode.tag, vnode.data, // #7975
            ...
            // a child.
            vnode.children && vnode.children.slice(), vnode.text, vnode.elm, vnode.context, vnode.componentOptions,
            vnode.asyncFactory);
        cloned.ns = vnode.ns;
   ...
   */
    ...
    strats.data = function (parentVal, childVal, vm) {
        if (!vm) {
            if (childVal && typeof childVal !== "function") {
                warn("The \"data\" option should be a function " + "that returns a per-instance value in component " +
                    "definitions.", vm);
    ...
    function normalizeProps(options, vm) {
        ...
        if (Array.isArray(props)) {
            ...
            warn("Invalid value for option \"props\": expected an Array or an Object, " + "but got " +
                (toRawType(props)) + ".", vm);
        }
        options.props = res;
    }
    ...
    function normalizeInject(options, vm) {
        ...
        if (Array.isArray(inject)) {
            ...
            warn("Invalid value for option \"inject\": expected an Array or an Object, " + "but got " +
                (toRawType(inject)) + ".", vm);
        }
    }
    ...
    function getInvalidTypeMessage(name, value, expectedTypes) {
        var message = "Invalid prop: type check failed for prop \"" + name + "\"." + " Expected " +
...

    {
        ...
        var warnReservedPrefix = function (target, key) {
            warn("Property \"" + key + "\" must be accessed with \"$data." + key + "\" because " +
                ...
                "prevent conflicts with Vue internals" + "See: https://vuejs.org/v2/api/#data", target);
        };
                ...
                var altKey = hyphenate(key);
                {
                    ...
                    if (key !== keyInLowerCase && attrs && hasOwn(attrs, keyInLowerCase)) {
                        tip("Prop \"" + keyInLowerCase + "\" is passed to component " +
                            (formatComponentName(tag || Ctor)) + ", but the declared prop name is" + " \"" + key +
                ...
                /* istanbul ignore else */
                {
                    defineReactive$$1(vm, key, result[key], function () {
                        warn("Avoid mutating an injected value directly since the changes will be " +
                            "overwritten whenever the provided component re-renders. " + "injection being mutated: \"" +
                            key + "\"", vm);
                    });
                }
            });
        ...
        Vue.prototype.$emit = function (event) {
            var vm = this;
            {
                ...
                if (lowerCaseEvent !== event && vm._events[lowerCaseEvent]) {
                    tip("Event \"" + lowerCaseEvent + "\" is emitted in component " + (formatComponentName(vm)) +
    ...
    if (inBrowser && !isIE) {
        ...
        if (performance && typeof performance.now === "function" && getNow() >
        ...
        for (var key in methods) {
            {
                if (typeof methods[key] !== "function") {
                    warn("Method \"" + key + "\" has type \"" + (typeof methods[key]) +
                        "\" in the component definition. " + "Did you reference the function correctly?", vm);
                }
                if (props && hasOwn(props, key)) {
    ...
    var mustUseProp = function (tag, type, attr) {
        return ((attr === "value" && acceptValue(tag)) && type !== "button" ||
            (attr === "selected" && tag === "option") || (attr === "checked" && tag === "input") ||
    ...
    var isBooleanAttr = makeMap("allowfullscreen,async,autofocus,autoplay,checked,compact,controls,declare," +
        ...
        "required,reversed,scoped,seamless,selected,sortable,translate," + "truespeed,typemustmatch,visible");
    ...
    function sameVnode(a, b) {
        return (a.key === b.key &&
            ((a.tag === b.tag && a.isComment === b.isComment && isDef(a.data) === isDef(b.data) &&
                sameInputType(a, b)) ||
    ...
    function createPatchFunction(backend) {
        ...
        function isUnknownElement$$1(vnode, inVPre) {
            return (!inVPre && !vnode.ns &&
                !(config.ignoredElements.length && config.ignoredElements.some(function (ignore) {
        ...
        function assertNodeMatch(node, vnode, inVPre) {
            if (isDef(vnode.tag)) {
                return vnode.tag.indexOf("vue-component") === 0 ||
                    (!isUnknownElement$$1(vnode, inVPre) && vnode.tag.toLowerCase() ===
    ...
    function genComponentModel(el, value, modifiers) {
        ...
        if (trim) {
            valueExpression =
                "(typeof " + baseValueExpression + " === 'string'" + "? " + baseValueExpression + ".trim()" + ": " +
                baseValueExpression + ")";
        }
        if (number) {
    ...
    function model(el, dir, _warn) {
        ...
        if (el.component) {
            ...
            warn$1(
                "<" + (el.tag) + " v-model=\"" + value + "\">: " + "v-model is not supported on this element type. " +
    ...
    function genCheckboxModel(el, value, modifiers) {
        ...
        addProp(el, "checked", "Array.isArray(" + value + ")" + "?_i(" + value + "," + valueBinding + ")>-1" +
            (trueValueBinding === "true" ? (":(" + value + ")") : (":_q(" + value + "," + trueValueBinding + ")")));
        addHandler(el, "change",
            "var $$a=" + value + "," + "$$el=$event.target," + "$$c=$$el.checked?(" + trueValueBinding + "):(" +
            falseValueBinding + ");" + "if(Array.isArray($$a)){" + "var $$v=" +
            (number ? "_n(" + valueBinding + ")" : valueBinding) + "," + "$$i=_i($$a,$$v);" +
            "if($$el.checked){$$i<0&&(" + (genAssignmentCode(value, "$$a.concat([$$v])")) + ")}" + "else{$$i>-1&&(" +
            (genAssignmentCode(value, "$$a.slice(0,$$i).concat($$a.slice($$i+1))")) + ")}" + "}else{" +
    ...
    function genSelect(el, value, modifiers) {
        ...
        var selectedVal = "Array.prototype.filter" + ".call($event.target.options,function(o){return o.selected})" +
            ".map(function(o){var val = \"_value\" in o ? o._value : o.value;" + "return " +
            (number ? "_n(val)" : "val") + "})";
    ...
    function updateStyle(oldVnode, vnode) {
        ...
        if (isUndef(data.staticStyle) && isUndef(data.style) && isUndef(oldData.staticStyle) &&
    ...
    function checkDuration(val, name, vnode) {
        if (typeof val !== "number") {
            warn("<transition> explicit " + name + " duration is not a valid number - " + "got " +
    ...
    var Transition = {
        ...
        render: function render(h) {
            ...
            if (children.length > 1) {
                warn("<transition> can only be used on a single element. Use " + "<transition-group> for lists.",
                    this.$parent);
            }
            ...
            child.key = child.key == null ? child.isComment ? id + "comment" : id + child.tag :
                isPrimitive(child.key) ? (String(child.key).indexOf(id) === 0 ? child.key : id + child.key) : child.key;
    ...
    function transformNode(el, options) {
        ...
        if (staticClass) {
            ...
            if (res) {
                warn("class=\"" + staticClass + "\": " + "Interpolation inside attributes has been removed. " +
    ...
    function transformNode$1(el, options) {
        ...
        if (staticStyle) {
            /* istanbul ignore if */
            {
                ...
                if (res) {
                    warn("style=\"" + staticStyle + "\": " + "Interpolation inside attributes has been removed. " +
                        "Use v-bind or the colon shorthand instead. For example, " +
    ...
    var isNonPhrasingTag = makeMap("address,article,aside,base,blockquote,body,caption,col,colgroup,dd," +
        ...
        "optgroup,option,param,rp,rt,source,style,summary,tbody,td,tfoot,th,thead," + "title,tr,track");
            ...
            start: function start(tag, attrs, unary, start$1, end) {
                ...
                if (isForbiddenTag(element) && !isServerRendering()) {
                    ...
                    warn$2("Templates should only be responsible for mapping the state to the " +
                        "UI. Avoid placing tags with side-effects in your templates, such as " + "<" + tag + ">" +
    ...
    function processIfConditions(el, parent) {
        ...
        if (prev && prev.if) {
            ...
            warn$2(
                "v-" + (el.elseif ? ("else-if=\"" + el.elseif + "\"") : "else") + " " + "used on element <" + (el.tag) +
                "> without corresponding v-if.", el.rawAttrsMap[el.elseif ? "v-else-if" : "v-else"]);
        }
    }
        ...
        if (el.tag === "template") {
            ...
            if (slotScope) {
                warn$2("the \"scope\" attribute for scoped slots have been deprecated and " +
                    ...
                    "can also be used on plain elements in addition to <template> to " + "denote scoped slots.",
                    el.rawAttrsMap["scope"], true);
            }
        ...
        if (el.tag === "slot") {
            ...
            if (el.key) {
                warn$2("`key` does not work on <slot> because slots are abstract outlets " +
                    "and can possibly expand into multiple elements. " + "Use the key on a wrapping element instead.",
                    getRawBindingAttr(el, "key"));
            }
        }
    }
        ...
        for (i = 0, l = list.length; i < l; i++) {
            ...
            if (dirRE.test(name)) {
                        ...
                        if (modifiers.sync) {
                            ...
                            if (!isDynamic) {
                                ...
                                if (hyphenate(name) !== camelize(name)) {
                                    addHandler(el, ("update:" + (hyphenate(name))), syncGen, null, false, warn$2,
                                        list[i]);
                                }
                            } else {
                                // handler w/ dynamic event name
                                addHandler(el, ("\"update:\"+(" + name + ")"), syncGen, null, false, warn$2, list[i],
                                    true // dynamic
                                );
                            }
                        }
                ...
                // literal attribute
                {
                    ...
                    if (res) {
                        warn$2(name + "=\"" + value + "\": " + "Interpolation inside attributes has been removed. " +
                            "Use v-bind or the colon shorthand instead. For example, " +
    ...
    function genHandler(handler) {
        ...
        if (!handler.modifiers) {
            ...
            var handlerCode = isMethodPath ? ("return " + (handler.value) + "($event)") :
                isFunctionExpression ? ("return (" + (handler.value) + ")($event)") :
    ...
    function genFilterCode(key) {
        ...
        return ("_k($event.keyCode," + (JSON.stringify(key)) + "," + (JSON.stringify(keyCode)) + "," + "$event.key," +
    ...
    function genFor(el, state, altGen, altHelper) {
        ...
        if (state.maybeComponent(el) && el.tag !== "slot" && el.tag !== "template" && !el.key) {
            state.warn("<" + (el.tag) + " v-for=\"" + alias + " in " + exp + "\">: component lists rendered with " +
                "v-for should have explicit keys. " + "See https://vuejs.org/guide/list.html#key for more info.",
    ...
    function genScopedSlot(el, state) {
        ...
        var fn = "function(" + slotScope + "){" + "return " + (el.tag === "template" ?
            el.if && isLegacySyntax ? ("(" + (el.if) + ")?" + (genChildren(el, state) || "undefined") + ":undefined") :
                genChildren(el, state) || "undefined" : genElement(el, state)) + "}";
    ...
    function checkEvent(exp, text, warn, range) {
        ...
        if (keywordMatch && stipped.charAt(keywordMatch.index - 1) !== "$") {
            warn("avoid using JavaScript unary operator as property name: " + "\"" + (keywordMatch[0]) +
                "\" in expression " + (text.trim()), range);
        }
                ...
                if (options) {
                    ...
                    if (options.directives) {
                        finalOptions.directives =
                            extend(Object.create(baseOptions.directives || null), options.directives);
                    }
                    // copy other options
